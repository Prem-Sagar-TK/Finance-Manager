...
export default function App() {
    ...
    return (
      <div>
        {Object.keys(budgets).length === 0 ? (
          <div className="text-center text-sm text-gray-400 p-6">No budgets set</div>
        ) : (
  ...
  return (
    <div className={`min-h-screen ${theme === 'light' ? 'bg-gray-50 text-gray-800' : 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 text-gray-100'}`}>
      {/* HEADER */}
